...
export const MessageThreadCreate = z.object({
  orderId: z.string().uuid().optional(),
  participantIds: z.array(z.string().uuid()).min(2).max(2), // Exactly 2 participants
});
...
export type MessageThreadCreateType = z.infer<typeof MessageThreadCreate>;
